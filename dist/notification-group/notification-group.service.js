...
exports.NotificationGroupService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let NotificationGroupService = class NotificationGroupService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async createNotificationGroup(data) {
    ...
    async updateNotificationGroup(id, data) {
