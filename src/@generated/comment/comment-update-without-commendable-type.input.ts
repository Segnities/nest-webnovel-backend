...
import { ComplaintTargetTypeUpdateOneRequiredWithoutCommentsNestedInput } from '../complaint-target-type/complaint-target-type-update-one-required-without-comments-nested.input';
...
@InputType()
export class CommentUpdateWithoutCommendableTypeInput {
    ...
    @Field(() => ComplaintTargetTypeUpdateOneRequiredWithoutCommentsNestedInput, {nullable:true})
    complainTargetType?: ComplaintTargetTypeUpdateOneRequiredWithoutCommentsNestedInput;
