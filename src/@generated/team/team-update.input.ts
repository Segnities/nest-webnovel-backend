...
import { UserUpdateManyWithoutTeamNestedInput } from '../user/user-update-many-without-team-nested.input';
...
export class TeamUpdateInput {
    ...
    @Field(() => UserUpdateManyWithoutTeamNestedInput, {nullable:true})
