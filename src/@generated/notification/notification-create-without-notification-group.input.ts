...
import { ReviewCreateNestedOneWithoutNotificationsInput } from '../review/review-create-nested-one-without-notifications.input';
import { AuthorCreateNestedOneWithoutNotificationsInput } from '../author/author-create-nested-one-without-notifications.input';

@InputType()
export class NotificationCreateWithoutNotificationGroupInput {
    ...
    @Field(() => ReviewCreateNestedOneWithoutNotificationsInput, {nullable:true})
