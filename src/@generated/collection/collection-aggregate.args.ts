...
import { CollectionAvgAggregateInput } from './collection-avg-aggregate.input';
import { CollectionSumAggregateInput } from './collection-sum-aggregate.input';
...
export class CollectionAggregateArgs {
    ...
    cursor?: Prisma.AtLeast<CollectionWhereUniqueInput, 'id' | 'title'>;
    ...
    @Field(() => CollectionAvgAggregateInput, {nullable:true})
    _avg?: CollectionAvgAggregateInput;

    @Field(() => CollectionSumAggregateInput, {nullable:true})
    _sum?: CollectionSumAggregateInput;
