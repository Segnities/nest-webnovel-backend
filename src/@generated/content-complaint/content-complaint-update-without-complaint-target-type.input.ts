...
import { UserUpdateOneRequiredWithoutIssuedContentComplaintsNestedInput } from '../user/user-update-one-required-without-issued-content-complaints-nested.input';
...
@InputType()
export class ContentComplaintUpdateWithoutComplaintTargetTypeInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutIssuedContentComplaintsNestedInput, {nullable:true})
    issuedByUser?: UserUpdateOneRequiredWithoutIssuedContentComplaintsNestedInput;
