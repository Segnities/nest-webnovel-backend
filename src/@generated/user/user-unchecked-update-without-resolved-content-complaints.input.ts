...
import { ComplaintReasonUncheckedUpdateManyWithoutUserNestedInput } from '../complaint-reason/complaint-reason-unchecked-update-many-without-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutResolvedContentComplaintsInput {
    ...
    @Field(() => ComplaintReasonUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
    complaintReasons?: ComplaintReasonUncheckedUpdateManyWithoutUserNestedInput;
