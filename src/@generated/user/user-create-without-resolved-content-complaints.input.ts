...
import { UserNotificationSettingsCreateNestedManyWithoutUserInput } from '../user-notification-settings/user-notification-settings-create-nested-many-without-user.input';
...
@InputType()
export class UserCreateWithoutResolvedContentComplaintsInput {
    ...
    @Field(() => UserNotificationSettingsCreateNestedManyWithoutUserInput, {nullable:true})
    userNotificationSettings?: UserNotificationSettingsCreateNestedManyWithoutUserInput;
