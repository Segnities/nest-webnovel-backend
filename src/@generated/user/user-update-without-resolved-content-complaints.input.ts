...
import { NewsUpdateManyWithoutUserNestedInput } from '../news/news-update-many-without-user-nested.input';
...
@InputType()
export class UserUpdateWithoutResolvedContentComplaintsInput {
    ...
    @Field(() => NewsUpdateManyWithoutUserNestedInput, {nullable:true})
