...
import { ChapterCreateNestedManyWithoutNovelInput } from '../chapter/chapter-create-nested-many-without-novel.input';
...
@InputType()
export class NovelCreateWithoutNovelCollectionMappingInput {
    ...
    @Field(() => ChapterCreateNestedManyWithoutNovelInput, {nullable:true})
