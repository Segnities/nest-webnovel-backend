...
import { ReviewUncheckedCreateNestedManyWithoutNovelInput } from '../review/review-unchecked-create-nested-many-without-novel.input';
...
@InputType()
export class NovelUncheckedCreateWithoutNovelCollectionMappingInput {
    ...
    @Field(() => ReviewUncheckedCreateNestedManyWithoutNovelInput, {nullable:true})
