...
import { NovelSubscriptionUncheckedUpdateManyWithoutNovelNestedInput } from '../novel-subscription/novel-subscription-unchecked-update-many-without-novel-nested.input';
...
@InputType()
export class NovelUncheckedUpdateWithoutNovelCollectionMappingInput {
    ...
    @Field(() => NovelSubscriptionUncheckedUpdateManyWithoutNovelNestedInput, {nullable:true})
    novelSubscription?: NovelSubscriptionUncheckedUpdateManyWithoutNovelNestedInput;
