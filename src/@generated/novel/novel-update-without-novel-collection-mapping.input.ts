...
import { ContinueReadingUpdateManyWithoutNovelNestedInput } from '../continue-reading/continue-reading-update-many-without-novel-nested.input';
...
@InputType()
export class NovelUpdateWithoutNovelCollectionMappingInput {
    ...
    @Field(() => ContinueReadingUpdateManyWithoutNovelNestedInput, {nullable:true})
    continueReading?: ContinueReadingUpdateManyWithoutNovelNestedInput;
