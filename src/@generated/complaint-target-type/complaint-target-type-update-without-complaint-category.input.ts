...
import { NewsUpdateManyWithoutComplainTargetTypeNestedInput } from '../news/news-update-many-without-complain-target-type-nested.input';
...
@InputType()
export class ComplaintTargetTypeUpdateWithoutComplaintCategoryInput {
    ...
    @Field(() => NewsUpdateManyWithoutComplainTargetTypeNestedInput, {nullable:true})
    news?: NewsUpdateManyWithoutComplainTargetTypeNestedInput;
